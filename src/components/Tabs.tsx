...
export const Tabs = ({
  ...
  return (
    <>
      ...
      >
        {propTabs.map((tab, idx) => (
          ...
          >
            ...
            <span
              className={cn(`relative block ${kanit.className}`, {
      ...
      <FadeInDiv
        tabs={tabs}
        active={active} // Pass the active tab to FadeInDiv
        hovering={hovering}
...
export const FadeInDiv = ({
  ...
  className?: string;
  tabs: Tab[];
  active: Tab; // Declare active as a prop
  hovering?: boolean;
}) => {
  const isActive = (tab: Tab) => {
    return tab.value === active.value; // Check against active prop
  };
  return (
